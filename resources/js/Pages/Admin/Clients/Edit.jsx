...
export default function Edit({ client }) {
    const [form, setForm] = useState({
        ...
        mobility_notes: client.mobility_notes || '',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            localStorage.setItem('auth_flash_success', 'Client updated successfully.');
            ...
            <div className="space-y-6 max-w-4xl mx-auto">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                        ...
                        <h1 className="text-2xl font-bold tracking-tight text-text">Edit Client</h1>
                        <p className="mt-1 text-sm text-text-muted">
                            Update profile details for {client.user?.first_name} {client.user?.last_name}.
                        </p>
                    </div>
                </div>
